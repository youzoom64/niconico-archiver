...
def process(pipeline_data):
    """Step11_06: comments.jsonを使用したスペシャルユーザー処理"""
    try:
        lv_value = pipeline_data['lv_value']
        config = pipeline_data['config']
        
        print(f"Step11_06 開始: {lv_value}")
